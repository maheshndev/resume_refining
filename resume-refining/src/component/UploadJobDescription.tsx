...
const UploadjobDescription: React.FC = () => {
  ...
  const getCSRFToken = () => {
    ...
    // Assuming the CSRF token is available in a meta tag
    ...
    try {
        ...
        // //body: formData,
        headers: {
          'Authorization': 'token 23bc2430faf8123:11bff37ffe244c4',
          "Content-Type": "application/json",
          'X-Frappe-CSRF-Token': csrfToken || '',
        },
        body: JSON.stringify({
          jd_text: "Your job description here",
          resumes_files: "base64_encoded_or_file_path_here"
      })
        ...
        <div className="card-body">
          ...
          {matchedData && (
            <div className="matched-results mt-4">
              ...
              {matchedData?.PerfectMatched && Array.isArray(matchedData.PerfectMatched) && matchedData.PerfectMatched.length > 0 && (
...
{matchedData?.TopMatched && Array.isArray(matchedData.TopMatched) && matchedData.TopMatched.length > 0 && (
  <div className="result-card mt-3">
...
{matchedData?.GoodMatched && Array.isArray(matchedData.GoodMatched) && matchedData.GoodMatched.length > 0 && (
  <div className="result-card mt-3">
